...
export default function CustomerSignIn() {
    return (
        <>
            <Navbar />
            <main className="absolute top-56.25 lg:top-42.25 w-full mx-auto flex justify-center items-center">
                <div className="my-10 bg-card border border-card-line rounded-xl shadow-2xs w-100 mx-10">
                    {/* Sign In */}
                    <div className="p-4 sm:p-7">
                        <div className="text-center">
                            ...
                            <p className="mt-2 text-sm text-muted-foreground-2">
                                ...
                                <Link className="text-primary decoration-2 hover:underline focus:outline-hidden focus:underline font-medium" to="/customer/signup">
                                    Sign up here
                                </Link>
                            </p>
                        </div>
