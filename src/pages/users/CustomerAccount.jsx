                        ...
                        <div className="flex justify-between">
                            <section className="flex gap-4">
                                <div className="hidden sm:inline-flex items-center justify-center size-12 rounded-full border border-line-4">
                                    ...
                                    >
                                        <desc>
                                            User 3 Line Streamline Icon: https://streamlinehq.com
                                        </desc>
                                    ...
                                    <span className="">
                                        ...
                                        >
                                            ...
                                            <g fill="none" fillRule="nonzero">
                                                <path
                                                    d="M24 0v24H0V0zM12.593 23.258l-0.011 0.002 -0.071 0.035 -0.02 0.004 -0.014 -0.004 -0.071 -0.035c-0.01 -0.004 -0.019 -0.001 -0.024 0.005l-0.004 0.01 -0.017 0.428 0.005 0.02 0.01 0.013 0.104 0.074 0.015 0.004 0.012 -0.004 0.104 -0.074 0.012 -0.016 0.004 -0.017 -0.017 -0.427c-0.002 -0.01 -0.009 -0.017 -0.017 -0.018m0.265 -0.113 -0.013 0.002 -0.185 0.093 -0.01 0.01 -0.003 0.011 0.018 0.43 0.005 0.012 0.008 0.007 0.201 0.093c0.012 0.004 0.023 0 0.029 -0.008l0.004 -0.014 -0.034 -0.614c-0.003 -0.012 -0.01 -0.02 -0.02 -0.022m-0.715 0.002a0.023 0.023 0 0 0 -0.027 0.006l-0.006 0.014 -0.034 0.614c0 0.012 0.007 0.02 0.017 0.024l0.015 -0.002 0.201 -0.093 0.01 -0.008 0.004 -0.011 0.017 -0.43 -0.003 -0.012 -0.01 -0.01z"
                                                    strokeWidth="1"
                                                ></path>
                                                <path
                                                    fill="currentColor"
                                                    d="M18.06 3a2 2 0 0 1 1.98 1.719l0.017 0.156 0.875 14a2 2 0 0 1 -1.847 2.12l-0.15 0.005H5.066a2 2 0 0 1 -2 -1.976l0.003 -0.149 0.875 -14a2 2 0 0 1 1.84 -1.869L5.94 3zm0 2H5.94l-0.875 14h13.87zM15 7a1 1 0 0 1 1 1 4 4 0 0 1 -8 0 1 1 0 0 1 2 0 2 2 0 0 0 3.995 0.15L14 8a1 1 0 0 1 1 -1"
                                                    strokeWidth="1"
                                                ></path>
                                            </g>
                                        </svg>
