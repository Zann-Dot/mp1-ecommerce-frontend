...
export default function OrderCard({ order }) {
    ...
    function getDeliveryAddress() {
        const address = order?.orderSummary.deliveryAddress;
        return `${address.addressLine} ${address.addressLine2 ?? ""} ${address.city} ${address.state} ${address.pincode} IN`;
    }
            ...
            <div className="flex flex-col justify-center gap-6 p-6 bg-card shadow-2xs rounded-xl">
                ...
                <div className="grid grid-cols-4 gap-x-2 sm:gap-x-3 md:gap-x-4">
                    ...
                    <div className="space-y-2.5">
                        <div className="flex items-center gap-x-1.5 text-xs sm:text-sm  text-neutral-900 dark:text-neutral-100">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 16 16"
                                id="Check-Line--Streamline-Mingcute"
                                height="16"
                                width="16"
                            >
                                <desc>
                    ...
                    <div className={`space-y-2.5`}>
                        ...
                        <div
                            className={`h-1.5 w-full bg-primary-800 dark:bg-neutral-300 rounded-full`}
                        />
                    </div>
                    ...
                    <div
                        className={`space-y-2.5 ${isDelivered ? "opacity-100" : "opacity-35"} transition-opacity`}
                    >
                        <div className="flex items-center gap-x-1.5 text-xs sm:text-sm text-foreground">
                            <span className="truncate">Delivered</span>
                        </div>
                        <div
                            className={`h-1.5 w-full ${isDelivered ? "bg-primary-800 dark:bg-neutral-300" : "bg-primary-400"} rounded-full`}
                        />
                    </div>
                </div>
                <hr />
