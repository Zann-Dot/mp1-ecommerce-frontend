        ...
        <div className="relative p-1.25  bg-surface rounded-2xl">
            ...
            <div className="flex items-center gap-30 grow ps-5 py-3 pb-5 font-medium">
                <div>
                    ...
                    <div className="inline-flex items-center">
                        ...
                        <span className="text-foreground text-[13px]">Order in progress</span>
                    </div>
                </div>

                <div>
                    <h1 className='font-normal text-muted-foreground-1 text-xs'>Order number</h1>
                    <span className="text-foreground text-[13px]">789453113</span>

                </div>

                <div>
                    <h1 className='font-normal text-muted-foreground-1 text-xs'>Order date</h1>
                    <span className="text-foreground text-[13px]">21/01/2026</span>

                </div>

                <div>
                    <h1 className='font-normal text-muted-foreground-1 text-xs'>Total</h1>
                    <span className="text-foreground text-[13px]">₹2999</span>
                </div>
            ...
            <div className="flex flex-col justify-center gap-6 p-6 bg-card shadow-2xs rounded-xl">
                <section className='flex items-center justify-between'>
                    ...
                    <button type="button" className="px-2 py-1 cursor-pointer inline-flex items-center gap-x-2 text-sm rounded-md bg-primary border border-primary-line text-primary-foreground hover:bg-primary-hover focus:outline-hidden focus:bg-primary-focus  disabled:opacity-50 disabled:pointer-events-none" >
                        Order Details
                    </button>
                </section>
                <hr />
