...
export default function ReviewHeader() {
    return (
        <header className="flex flex-wrap sm:justify-start sm:flex-nowrap w-full py-3 bg-navbar border-b border-navbar-line">
            <nav className="max-w-270 w-full mx-auto px-4 flex flex-wrap gap-y-2 basis-full items-center justify-between">
                <Link
                ...
                <div
                    ...
                    role="region"
                >
                    <ol className="flex items-center whitespace-nowrap text-xs md:text-sm font-semibold text-foreground">
