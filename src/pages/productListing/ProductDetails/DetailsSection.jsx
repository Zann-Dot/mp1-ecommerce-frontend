    ...
    return (
        <div className="text-foreground col-span-5 md:col-span-2 px-1 md:px-10">
            <div className="flex flex-col gap-1">
                <p className="text-sm text-muted-foreground-1">Category</p>
                <h1 className="text-3xl font-medium">Tshirt</h1>
                <h4 className="text-lg">₹455</h4>
            </div>

            <div className="flex mt-8 text-sm gap-2">
                <div className="flex items-center gap-0.5">
                    ...
                    <svg
                        className="shrink-0 size-3 text-muted-foreground/50"
                        xmlns="http://www.w3.org/2000/svg"
                        width="16"
                        height="16"
                        fill="currentColor"
            ...
            <div className="grid grid-cols-4 gap-2">
                <div className="p-1 cursor-pointer border border-line-3 rounded-lg grid place-items-center">
                    S
                </div>
                <div className="p-1 cursor-pointer border border-line-3 rounded-lg grid place-items-center">
                    M
            ...
            <div className="flex items-center mt-8 gap-2">
                ...
                <button
                    type="button"
                    class="cursor-pointer py-3 px-4 w-full text-center gap-x-2 text-sm font-medium rounded-lg bg-primary border border-primary-line text-primary-foreground hover:bg-primary-hover focus:outline-hidden focus:bg-primary-focus  disabled:opacity-50 disabled:pointer-events-none"
                >
                    Add to cart
                </button>
                <button
                    type="button"
                    class="cursor-pointer py-3 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-layer-line bg-layer text-layer-foreground shadow-2xs hover:bg-layer-hover focus:outline-hidden focus:bg-layer-focus  disabled:opacity-50 disabled:pointer-events-none"
                >
                    <svg
