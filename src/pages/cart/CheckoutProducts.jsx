            ...
            <div className="flex-1 w-full flex flex-col gap-y-4">
                ...
                <div className="w-full grid grid-cols-3 gap-x-4 sm:gap-x-8">
                    ...
                    <div className="flex flex-col items-start gap-y-1">
                        ...
                        <select class="p-2 pe-9 block w-15 bg-layer border-line-3 rounded-lg text-xs text-foreground focus:border-primary-focus focus:ring-primary-focus disabled:opacity-50 disabled:pointer-events-none">
                            <option>1</option>
                            <option>2</option>
                            <option>3</option>
                            <option>4</option>
