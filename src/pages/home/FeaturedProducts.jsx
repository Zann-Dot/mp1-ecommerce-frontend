            ...
            >
                ...
                <div className="flex items-center text-muted-foreground-1 gap-x-1.5">
                    ...
                    <div className="flex items-center">
                        <svg
                            className={`shrink-0 size-3.5 ${product.ratings >= 10 ? "text-primary" : "text-muted-foreground/50"}`}
                            xmlns="http://www.w3.org/2000/svg"
                            width="16"
                            height="16"
                            fill="currentColor"
                        ...
                        <svg
                            className={`shrink-0 size-3.5 ${product.ratings >= 20 ? "text-primary" : "text-muted-foreground/50"}`}
                            xmlns="http://www.w3.org/2000/svg"
                            width="16"
                            height="16"
                            fill="currentColor"
                        ...
                        <svg
                            className={`shrink-0 size-3.5 ${product.ratings >= 30 ? "text-primary" : "text-muted-foreground/50"}`}
                            xmlns="http://www.w3.org/2000/svg"
                            width="16"
                            height="16"
                            fill="currentColor"
