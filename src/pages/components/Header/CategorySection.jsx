        ...
        <div className='max-w-340 w-full mx-auto px-4 pb-2'>
            <div className="relative flex items-center gap-1 basis-full">
                <div className="flex flex-row items-center gap-1 overflow-x-auto scrollbar-none">
                    <button type="button" class="relative w-full text-start whitespace-nowrap cursor-pointer py-1 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-full border border-transparent text-muted-foreground-2 hover:bg-muted-hover focus:outline-hidden focus:bg-muted-focus disabled:opacity-50 disabled:pointer-events-none">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" className='stroke-muted-foreground-2' viewBox="0 0 24 24" id="Layers-Stacked--Streamline-Ultimate" height="14" width="14">
                            ...
                            <path stroke-linecap="round" stroke-linejoin="round" d="m22.91 6.95302 -10.21 -5.281c-0.2189 -0.11304 -0.4617 -0.17202 -0.708 -0.17202 -0.2464 0 -0.4891 0.05898 -0.708 0.17202l-10.208 5.281c-0.10056 0.05168 -0.184927 0.13007 -0.243833 0.22657 -0.058906 0.0965 -0.090071 0.20737 -0.090071 0.32043s0.031165 0.22393 0.090071 0.32043 0.143273 0.17489 0.243833 0.22657L11.285 13.328c0.2189 0.1131 0.4616 0.172 0.708 0.172 0.2463 0 0.4891 -0.0589 0.708 -0.172L22.91 8.04702c0.1003 -0.05192 0.1843 -0.13041 0.243 -0.22688s0.0897 -0.20721 0.0897 -0.32012c0 -0.11291 -0.031 -0.22365 -0.0897 -0.32012 -0.0587 -0.09647 -0.1427 -0.17495 -0.243 -0.22688Z" stroke-width="1.5"></path>
                            <path stroke-linecap="round" stroke-linejoin="round" d="M0.757996 17.25 11.285 22.328c0.2189 0.113 0.4616 0.172 0.708 0.172 0.2463 0 0.4891 -0.059 0.708 -0.172l10.557 -5.078" stroke-width="1.5"></path>
                            <path stroke-linecap="round" stroke-linejoin="round" d="M0.757996 12.75 11.285 17.828c0.2189 0.113 0.4616 0.172 0.708 0.172 0.2463 0 0.4891 -0.059 0.708 -0.172l10.557 -5.078" stroke-width="1.5"></path>
                        </svg>
                        Pages
                    </button>
                    ...
                    <button type="button" class="relative w-full text-start whitespace-nowrap cursor-pointer py-1 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-full border border-transparent text-muted-foreground-2 hover:bg-muted-hover focus:outline-hidden focus:bg-muted-focus disabled:opacity-50 disabled:pointer-events-none">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" className='stroke-muted-foreground-2' viewBox="0 0 24 24" id="Discount--Streamline-Ultimate" height="12" width="12">
                            ...
                            <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 19c0 0.862 0.3424 1.6886 0.9519 2.2981 0.6095 0.6095 1.4361 0.9519 2.2981 0.9519 0.862 0 1.6886 -0.3424 2.2981 -0.9519 0.6095 -0.6095 0.9519 -1.4361 0.9519 -2.2981 0 -0.862 -0.3424 -1.6886 -0.9519 -2.2981 -0.6095 -0.6095 -1.4361 -0.9519 -2.2981 -0.9519 -0.862 0 -1.6886 0.3424 -2.2981 0.9519 -0.6095 0.6095 -0.9519 1.4361 -0.9519 2.2981Z" stroke-width="1.5"></path>
                            <path stroke-linecap="round" stroke-linejoin="round" d="M1.75 5c0 0.86195 0.34241 1.6886 0.9519 2.2981C3.3114 7.90759 4.13805 8.25 5 8.25c0.86195 0 1.6886 -0.34241 2.2981 -0.9519C7.90759 6.6886 8.25 5.86195 8.25 5c0 -0.86195 -0.34241 -1.6886 -0.9519 -2.2981C6.6886 2.09241 5.86195 1.75 5 1.75c-0.86195 0 -1.6886 0.34241 -2.2981 0.9519C2.09241 3.3114 1.75 4.13805 1.75 5Z" stroke-width="1.5"></path>
                            <path stroke-linecap="round" stroke-linejoin="round" d="M3.30998 23.2501c-0.1006 -0.004 -0.19937 -0.0281 -0.29043 -0.0711 -0.09105 -0.0429 -0.17253 -0.1038 -0.23957 -0.1789l-1.78 -1.78c-0.140451 -0.1406 -0.21934 -0.3312 -0.21934 -0.53 0 -0.1987 0.078889 -0.3894 0.21934 -0.53L20.16 1.0001c0.1406 -0.140449 0.3312 -0.219338 0.53 -0.219338 0.1987 0 0.3894 0.078889 0.53 0.219338l1.78 1.78c0.1404 0.14063 0.2193 0.33125 0.2193 0.53 0 0.19875 -0.0789 0.38938 -0.2193 0.53l-19.16002 19.16c-0.06704 0.0751 -0.14852 0.136 -0.23957 0.1789 -0.09106 0.043 -0.18983 0.0671 -0.29043 0.0711Z" stroke-width="1.5"></path>
                        </svg>
                        Sales
                    </button>

                    <button type="button" class="relative w-full text-start whitespace-nowrap cursor-pointer py-1 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-full border border-transparent text-muted-foreground-2 hover:bg-muted-hover focus:outline-hidden focus:bg-muted-focus disabled:opacity-50 disabled:pointer-events-none">
                        <svg className="stroke-muted-foreground-2" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <button type="button" class="relative w-full text-start whitespace-nowrap cursor-pointer py-1 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-full border border-transparent text-muted-foreground-2 hover:bg-muted-hover focus:outline-hidden focus:bg-muted-focus disabled:opacity-50 disabled:pointer-events-none">
                        <svg class="zeqf6 r390y" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <button type="button" class="relative w-full text-start whitespace-nowrap cursor-pointer py-1 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-full border border-transparent text-muted-foreground-2 hover:bg-muted-hover focus:outline-hidden focus:bg-muted-focus disabled:opacity-50 disabled:pointer-events-none">
                        <svg class="stroke-muted-foreground-2" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <button type="button" class="relative w-full text-start whitespace-nowrap cursor-pointer py-1 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-full border border-transparent text-muted-foreground-2 hover:bg-muted-hover focus:outline-hidden focus:bg-muted-focus disabled:opacity-50 disabled:pointer-events-none">
                        <svg class="stroke-muted-foreground-2" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
