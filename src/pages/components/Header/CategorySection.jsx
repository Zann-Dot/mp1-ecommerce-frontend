        ...
        <div className='max-w-340 w-full mx-auto px-4 pb-2'>
            <div className="relative flex items-center gap-1 basis-full">
                <div className="flex flex-row items-center gap-1 overflow-x-auto scrollbar-none">
                    ...
                    <button type="button" className="relative w-full text-start whitespace-nowrap cursor-pointer py-1 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-full border border-transparent text-muted-foreground-2 hover:bg-muted-hover focus:outline-hidden focus:bg-muted-focus disabled:opacity-50 disabled:pointer-events-none">
                        <svg className="zeqf6 r390y" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <button type="button" className="relative w-full text-start whitespace-nowrap cursor-pointer py-1 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-full border border-transparent text-muted-foreground-2 hover:bg-muted-hover focus:outline-hidden focus:bg-muted-focus disabled:opacity-50 disabled:pointer-events-none">
                        <svg className="stroke-muted-foreground-2" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <button type="button" className="relative w-full text-start whitespace-nowrap cursor-pointer py-1 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-full border border-transparent text-muted-foreground-2 hover:bg-muted-hover focus:outline-hidden focus:bg-muted-focus disabled:opacity-50 disabled:pointer-events-none">
                        <svg className="stroke-muted-foreground-2" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
